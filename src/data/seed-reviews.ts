...
export const reviews: SeedReview[] = [
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Beautiful set with rich colors. One mug had a tiny glaze imperfection, but the seller offered a replacement immediately. Great customer service.",
  },
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Bought this as a gift for my mother and she nearly cried. The craftsmanship is extraordinary. The fringe detailing is impeccable.",
  },
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Bought this for my wife. The leather quality is outstanding. Only minor note: it's quite heavy empty, but that's the trade-off for real full-grain leather.",
  },
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Best cutting board I've ever owned. The weight keeps it stable, the walnut is hard enough to resist deep scratches, and it's easy to maintain with mineral oil.",
  },
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Excellent wok once properly seasoned. The initial seasoning process takes patience but the results are worth it. The handle gets a bit warm so use a towel.",
  },
  ...
  // Celadon Glaze Vase
  {
    ...
    rating: 5,
    comment:
      "The crackle pattern in the glaze is exquisite. In morning light it reads blue-green, in evening light it shifts to warm gray. Truly a living piece of art.",
  },
  ...
  // Minimalist Leather Wallet
  {
    ...
    rating: 5,
    comment:
      "Replaced a bulky wallet with this and I'll never go back. Holds everything I need, the Horween leather is incredible, and the hand-burnished edges show real craftsmanship.",
  },
  ...
  // Silver Leaf Pendant
  {
    ...
    rating: 5,
    comment:
      "The detail on this tiny leaf is unbelievable. You can see every vein under a magnifying glass. It looks like a real leaf that was dipped in silver. Beautifully packaged too.",
  },
  ...
  // Block-Printed Cotton Throw
  {
    ...
    rating: 5,
    comment:
      "The colors are vibrant and the print registration is surprisingly precise for hand block printing. You can see slight variations that prove it's handmade. Love it.",
  },
  ...
  // Japanese Joinery Shelf
  {
    ...
    rating: 5,
    comment:
      "I'm a woodworker myself and I'm impressed. The through-tenon joint is executed flawlessly. People can't believe there are no screws when I show them. Engineering meets art.",
  },
];
